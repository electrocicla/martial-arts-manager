      ...
      {tests.length === 0 ? (
        <div className="card bg-base-200">
          <div className="card-body text-center py-12">
            ...
            <h3 className="text-lg font-bold text-base-content mb-2">No Upcoming Tests</h3>
            <p className="text-base-content/70">There are no belt tests scheduled at this time.</p>
          </div>
        </div>
      ) : (
        tests.map((test) => (
