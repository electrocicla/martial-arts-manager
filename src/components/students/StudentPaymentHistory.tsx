    ...
    <div className="space-y-6 min-w-0">
      ...
      <div className="flex flex-wrap gap-2 border-b border-gray-700 pb-3">
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 active:scale-[0.97] border ${
            filter === 'all'
              ? 'bg-gradient-to-br from-red-600 to-red-700 text-white shadow-lg shadow-red-900/40 border-red-600'
              : 'text-gray-400 hover:text-white hover:bg-gray-700/80 border-gray-700/50'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 active:scale-[0.97] border ${
            filter === 'completed'
              ? 'bg-gradient-to-br from-emerald-600 to-green-700 text-white shadow-lg shadow-green-900/40 border-emerald-600'
              : 'text-gray-400 hover:text-white hover:bg-gray-700/80 border-gray-700/50'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 active:scale-[0.97] border ${
            filter === 'pending'
              ? 'bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-900/40 border-amber-500'
              : 'text-gray-400 hover:text-white hover:bg-gray-700/80 border-gray-700/50'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 active:scale-[0.97] border ${
            filter === 'failed'
              ? 'bg-gradient-to-br from-red-700 to-rose-800 text-white shadow-lg shadow-red-900/40 border-red-700'
              : 'text-gray-400 hover:text-white hover:bg-gray-700/80 border-gray-700/50'
          }`}
        >
